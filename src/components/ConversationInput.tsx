      ...
      {showSingleModelConvoInput && (
        <div style={{ padding: `${spacing.md} 0 0 0` }}>
          {(responses.length > 0 && lastSubmittedPrompt) && (
            <div style={{ display: 'flex', justifyContent: 'stretch', gap: spacing.sm, marginBottom: spacing.md, width: '100%' }}>
              <div style={{ position: 'relative', flex: 1, display: 'flex' }}>
                ...
                <div
                  style={{ position: 'absolute', top: '-6px', right: '-6px', cursor: 'help', zIndex: zIndex.base }}
