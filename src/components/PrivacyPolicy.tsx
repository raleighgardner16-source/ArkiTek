...
const PrivacyPolicy = ({ onNavigate }: Props) => {
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        >
          ...
          <div style={sectionStyle}>
            ...
            <h3 style={{ ...headingStyle, fontSize: fontSize['3xl'], marginTop: spacing.xl }}>2.1 Account Information</h3>
            <p style={paragraphStyle}>
            ...
            <h3 style={{ ...headingStyle, fontSize: fontSize['3xl'], marginTop: spacing.xl }}>2.2 Usage Data</h3>
            <p style={paragraphStyle}>
            ...
            <h3 style={{ ...headingStyle, fontSize: fontSize['3xl'], marginTop: spacing.xl }}>2.3 Payment Information</h3>
            <p style={paragraphStyle}>
            ...
            <h3 style={{ ...headingStyle, fontSize: fontSize['3xl'], marginTop: spacing.xl }}>2.4 Automatically Collected Information</h3>
            <p style={paragraphStyle}>
