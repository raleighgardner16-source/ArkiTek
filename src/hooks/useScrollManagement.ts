...
interface UseScrollManagementProps {
  ...
  inlineResponseText: string | null
  lastSubmittedPrompt: string
  summaryConvoLength: number
  singleModelConvoLength: number
}
...
export function useScrollManagement({
  ...
  const [councilGutterHover, setCouncilGutterHover] = useState<string | null>(null)
  ...
  const handleCouncilGutterWheel = useCallback((e: WheelEvent) => {
    e.preventDefault()
